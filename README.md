...
#>  1 -0.765  2ºC   RB867515   1.13   0.845   -0.369  0.918       1.61   0.531 
#>  2 -1.23   3ºC   RB867515   1.13  -0.394   -0.462 -0.361       1.33  -1.03  
#>  3 -0.0301 6ºC   RB966928   0.690  0.388   -0.438  0.0726     -0.190 -0.0904
#>  4 -0.941  3ºCB  SP813250  -1.09  -0.511   -0.161 -0.603       1.82  -0.460 
#>  5 -0.212  2ºC   RB966928  -0.643 -1.40     1.79  -1.27       -0.753 -1.01  
#>  6  0.411  3ºC   RB867515   0.690  0.00921 -0.464  0.0832      0.128  0.798 
#>  7  0.180  12mB  RB867515   1.13  -1.63     3.02  -1.67        3.05  -1.32  
#>  8  0.658  15m   RB966928  -0.199 -0.0291  -0.456 -0.235      -0.577 -0.250 
#>  9 -1.27   3ºC   RB92579   -0.199  0.291   -0.149  0.0732      0.656  0.481 
#> 10 -0.596  12mB  RB92579   -1.09  -0.643    0.400 -0.130       1.18  -0.684 
#> # i 14,832 more rows
...
#> 1        7.20e-16         26    15 rmse    standard    11.5     5   0.450
#> 2        4.55e-18          7    30 rmse    standard    15.4     5   0.256
...
#> 
#>        1) root 14842 1.377851e+07  91.33464  
#>          2) corte=12m,2ºC,2ºCB,3ºC,3ºCB,4ºC,4ºCB,5ºC,5ºCB,6ºC,6ºCB,7ºC,7ºCB,8ºC,9ºC,9ºCB 11637 6.574273e+06  80.73321  
#>            4) corte=3ºC,4ºC,5ºC,6ºC,7ºC,7ºCB,8ºC,9ºC,9ºCB 7916 3.244075e+06  72.64283  
#>              8) variedade=CV7231,IACSP9550,RB855453,RB855536,RB867515,RB92579,RB965902,SP813250,outro 5224 1.876385e+06  67.35721  
#>               16) corte=4ºC,5ºC,6ºC,7ºCB,9ºC,9ºCB 2712 6.590262e+05  61.07380  
#>                 32) mes>=0.9121611 1256 2.794316e+05  55.42013  
#>                   64) idade_real< -0.1367595 826 1.145996e+05  51.32955  
#>                    128) idade_real< -0.7006278 155 2.857088e+04  44.74781  
#>                      256) atr>=0.9586254 70 3.984307e+03  37.43871  
#>                        512) atr< 1.365127 40 6.586975e-01  33.44225  
#>                         1024) atr>=1.146775 5 0.000000e+00  33.12000 *
#>                         1025) atr< 1.146775 35 6.529714e-02  33.48829  
#>                           2050) k_2< -0.06348294 22 5.927273e-03  33.47818  
#>                             4100) mo_2>=0.4280028 5 1.920000e-03  33.46400 *
#>                             4101) mo_2< 0.4280028 17 2.705882e-03  33.48235  
#>                               8202) s_2< -0.3564666 10 1.050000e-03  33.47500 *
#>                               8203) s_2>=-0.3564666 7 3.428571e-04  33.49286 *
#>                           2051) k_2>=-0.06348294 13 5.332308e-02  33.50538 *
#>                        513) atr>=1.365127 30 2.492954e+03  42.76733  
#>                         1026) variedade=SP813250,outro 23 9.072375e+01  37.83609  
#>                           2052) atr>=1.643884 16 4.880174e+01  36.94312  
#>                             4104) atr< 2.101384 7 2.102980e+01  35.51000 *
#>                             4105) atr>=2.101384 9 2.212956e+00  38.05778 *
#>                           2053) atr< 1.643884 7 2.542857e-03  39.87714 *
#>                         1027) variedade=IACSP9550,RB867515 7 5.250000e+00  58.97000 *
#>                      257) atr< 0.9586254 85 1.776730e+04  50.76706  
#>                        514) atr< 0.01342367 67 7.833181e+03  45.73209  
#>                         1028) idade_real< -0.8768366 16 5.388958e+01  31.40625  
#>                           2056) p_resina_2>=-0.4928771 11 3.054000e-01  30.81000 *
#>                           2057) p_resina_2< -0.4928771 5 4.107008e+01  32.71800 *
#>                         1029) idade_real>=-0.8768366 51 3.465444e+03  50.22647  
#>                           2058) atr< -0.9565346 15 1.724574e+02  42.74800  
#>                             4116) variedade=RB867515 9 1.620000e-02  39.98000 *
#>                             4117) variedade=RB92579 6 5.020000e-02  46.90000 *
#>                           2059) atr>=-0.9565346 36 2.104526e+03  53.34250  
#>                             4118) sb_2>=-0.3607528 27 2.312344e+02  50.38074  
#>                               8236) p_resina_2< 0.04075588 19 3.108495e+00  49.43053  
#>                                16472) mes>=1.356579 10 1.509000e-02  49.16900 *
#>                                16473) mes< 1.356579 9 1.649489e+00  49.72111 *
#>                               8237) p_resina_2>=0.04075588 8 1.702270e+02  52.63750 *
#>                             4119) sb_2< -0.3607528 9 9.259140e+02  62.22778 *
#>                        515) atr>=0.01342367 18 1.913375e+03  69.50833  
#>                         1030) ctc_2>=0.4578193 5 1.390249e+03  60.82600 *
#>                         1031) ctc_2< 0.4578193 13 1.244231e+00  72.84769 *
#>                    129) idade_real>=-0.7006278 671 7.776321e+04  52.84993  
#> 
#> ...
#> and 3512 more lines.
...
#> 
#> Call:
#>  randomForest(x = maybe_data_frame(x), y = y, ntree = ~59L, mtry = min_cols(~29L,      x), nodesize = min_rows(~2L, x)) 
#>                Type of random forest: regression
#>                      Number of trees: 59
#> No. of variables tried at each split: 17
#> 
#>           Mean of squared residuals: 67.13665
#>                     % Var explained: 92.77
